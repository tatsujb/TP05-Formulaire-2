...
<html>
    ...
    <body>
        <form method="post" action="inscription">
            <span class="erreur">${requestScope.form.erreurs.existe}</span>
            <fieldset>
                ...
                <input type="text" id="name" name="name" value=" <c:out value="${requestScope.utilisateur.name}"/>" size="20" maxlength="20" />
                <span class="erreur">${requestScope.form.erreurs.name}</span>
                <br />
